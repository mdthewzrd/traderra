  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-amber-500/90 text-zinc-950 shadow-lg shadow-amber-500/20 ring-1 ring-amber-300/50 transition hover:bg-amber-400 hover:scale-105"
      ...
      >
        ...
        {openCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-rose-500 px-1 text-[10px] font-bold text-white ring-2 ring-zinc-950">
            {openCount}
          </span>
        )}
      </button>
