...
export const IND_REGISTRY: Record<string, IndDef> = {
  ...
  adp_bands: { label: 'Adaptive Dev Band', group: 'Dev Bands', colors: ['adp_bands_up_fill', 'adp_bands_up_line', 'adp_bands_dn_fill', 'adp_bands_dn_line', 'adp_bands_center'], colorLabels: ['Upper Fill', 'Upper Line', 'Lower Fill', 'Lower Line', 'Center Line'], params: [{ key: 'xtreme', label: 'Partial Band', def: 6, step: 0.1 }, { key: 'euThr', label: 'Extreme Band', def: 6.9, step: 0.1 }, { key: 'emaFast', label: 'Chase EMA', def: 20, min: 1, max: 100 }, { key: 'wMin', label: 'Min Influence', def: 0.10, step: 0.05, min: 0, max: 1 }, { key: 'wMax', label: 'Max Influence', def: 0.40, step: 0.05, min: 0, max: 1 }, { key: 'showCenter', label: 'Show Center', def: 1, type: 'toggle' }] },
  db_72_89_tight: { label: 'Dev Band 72/89 Tight', group: 'Dev Bands', colors: ['db_72_89_tight_up_fill', 'db_72_89_tight_up_line', 'db_72_89_tight_dn_fill', 'db_72_89_tight_dn_line'], colorLabels: ['Upper Fill', 'Upper Line', 'Lower Fill', 'Lower Line'], params: [{ key: 'fast', label: 'Fast', def: 72, min: 1, max: 500 }, { key: 'slow', label: 'Slow', def: 89, min: 1, max: 500 }, { key: 'upLow', label: 'Up Mult Low', def: 3, step: 0.1 }, { key: 'upHigh', label: 'Up Mult High', def: 3.3, step: 0.1 }, { key: 'dnLow', label: 'Dn Mult Low', def: 3.6, step: 0.1 }, { key: 'dnHigh', label: 'Dn Mult High', def: 3.9, step: 0.1 }] },
