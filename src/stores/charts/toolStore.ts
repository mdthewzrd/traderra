...
export const IND_CATALOG: Record<string, IndCatalogEntry> = {
  ...
  emacloud:       { label:'EMA Cloud',        group:'EMA Bands',   params:[{key:'fast',label:'Fast EMA',def:9,min:1,max:500},{key:'slow',label:'Slow EMA',def:20,min:1,max:500}], colors:[{key:'bull_fill',label:'Bull Fill',def:'rgba(34,197,94,.15)'},{key:'bull_line',label:'Bull Line',def:'rgba(34,197,94,.50)'},{key:'bear_fill',label:'Bear Fill',def:'rgba(239,68,68,.15)'},{key:'bear_line',label:'Bear Line',def:'rgba(239,68,68,.50)'}], legacyKeys:['emacloud'] },
  ema_cross:      { label:'EMA Cross Switch', group:'EMA Bands',   params:[{key:'fast',label:'Fast EMA',def:9,min:1,max:500},{key:'slow',label:'Slow EMA',def:20,min:1,max:500},{key:'wedgeSize',label:'Wedge Size',def:6,min:3,max:20}], colors:[{key:'wedge_up',label:'Bull Wedge',def:'rgba(34,197,94,0.95)'},{key:'wedge_down',label:'Bear Wedge',def:'rgba(239,68,68,0.95)'}], legacyKeys:['ema_cross'] },
  ...
  mikesbands:    { label:"Mike's Bands", group:'Trendlines', combo:true,
    params:[
      ...
      {key:'tlShowSwings',label:'Show Swings (EMA respect)',def:1,type:'toggle',group:'display'},
      {key:'tlCurlProj',label:'Curl Projection (re-fit)',def:0,type:'toggle',group:'curl'},
  ...
  linguafast:    { label:'Lingua Cycle (Fast)', group:'Lingua', combo:true,
    params:[
      {key:'lfFast1',label:'Fast Cloud EMA 1',def:9,min:1,max:200,group:'fast cloud'},
      {key:'lfFast2',label:'Fast Cloud EMA 2',def:20,min:1,max:200,group:'fast cloud'},
      {key:'lfSlow1',label:'Slow Cloud EMA 1',def:72,min:1,max:400,group:'slow cloud'},
      {key:'lfSlow2',label:'Slow Cloud EMA 2',def:89,min:1,max:400,group:'slow cloud'},
    ],
    colors:[
      {key:'lf_fast',label:'Fast Cloud edge',def:'rgba(0,229,255,0.7)'},{key:'lf_slow',label:'Slow Cloud edge',def:'rgba(180,160,90,0.45)'},
